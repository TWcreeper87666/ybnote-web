...
export const OverlayLayer: React.FC<OverlayLayerProps> = ({ mode, latestPerformHit }) => (
  <>
    <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', background: 'radial-gradient(circle, transparent 20%, rgba(0,0,0,0.85) 100%)', opacity: mode === 'play' ? 1 : 0, transition: 'opacity 1s ease-in-out', zIndex: 10 }} />
    ...
    <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', pointerEvents: 'none', opacity: mode === 'play' ? 0.5 : 0, transition: 'opacity 0.3s ease-in-out', color: 'white', zIndex: 11 }}>
